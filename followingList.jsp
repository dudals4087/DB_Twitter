...
<%
    ...
    if (profileUser == null || profileUser.isEmpty()) {
        errorMsg = "어떤 사용자의 팔로잉을 볼지 알 수 없습니다";
    }
    ...
    try {
        ...
        if (errorMsg == null && canViewList) {
            // 팔로잉 목록: followings 테이블에서 user_id = profileUser 인 행들의 follower_id 들
            String fsql =
        ...
        if (errorMsg == null && profilePrivate && !isOwner && !alreadyFollowing) {
            errorMsg = "비밀계정이에요 팔로우한 사람만 팔로잉을 볼 수 있습니다";
        }

    } catch (Exception e) {
        e.printStackTrace();
        if (errorMsg == null) errorMsg = "팔로잉 정보를 불러오는 중 오류가 발생했습니다";
    }
...
<head>
    <meta charset="UTF-8">
    <title><%= profileUser %> 님의 팔로잉  TWITTER_DB4</title>
...
<div class="app-shell">
    ...
    <header class="app-header">
        <div class="app-header-left">
            ...
            <div class="app-logo-sub"><%= profileUser %> 님의 팔로잉</div>
        </div>
    ...
    <div class="center-layout">
        <section class="center-column">
            <div class="card">
                ...
                %>
                    <div class="section-title"><%= profileUser %> 님의 팔로잉</div>
                    <%
                        if (followings.isEmpty()) {
                    %>
                        <div class="helper-text">아직 팔로잉한 사용자가 없습니다</div>
                    <%
                        } else {
